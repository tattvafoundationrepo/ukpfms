...
//                    + Constants.DDMMYYYYFORMAT2.format(asOnDate) + "'", new StringBuffer(vimsQueryMapEntry.getKey()), vimsQueryMapEntry.getValue());
            final List<Object[]> resultForVoucher = budgetDetailService.fetchActualsForFYWithParams(fromDate, Constants.DDMMYYYYFORMAT2.format(asOnDate), new StringBuffer(vimsQueryMapEntry.getKey()), vimsQueryMapEntry.getValue());
...
//                    + Constants.DDMMYYYYFORMAT2.format(asOnDate) + "'", new StringBuffer(bmisQueryMapEntry.getKey()), bmisQueryMapEntry.getValue());
            final List<Object[]> resultForBill = budgetDetailService.fetchActualsForBillWithVouchersParams(fromDate, Constants.DDMMYYYYFORMAT2.format(asOnDate), new StringBuffer(bmisQueryMapEntry.getKey()), bmisQueryMapEntry.getValue());
